...
const char* topic_autoVerder = "Farmlab2/auto/Verder";
...
//VAR
int b = 0;
const int DELAY_AFTER_MOVING_SERVO = 2000; // delay in milliseconds after moving the servo
const int DELAY_AFTER_TAKING_PHOTO = 4500; // delay in milliseconds after taking a photo
...
void loop() {
  ...
  switch (toestand) {
    ...
    case FotoAUTO:
      ...
      Serial.println("Send bevesting");
      client.publish(topic_autoVerder, "0");
      b = 0;
